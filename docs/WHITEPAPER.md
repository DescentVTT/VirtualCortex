...
<!-- @assert-count target="runtime/cortex-runtime/tests/instrument.rs" symbol="_exhaustive" min="18" reason="ADR-0066 and ADR-0069: the ten full runs, the two calibrations and the six addressed runs are weekly" -->
