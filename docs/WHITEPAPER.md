...
<!-- @assert-count target="runtime/cortex-runtime/tests/instrument.rs" symbol="_exhaustive" min="12" reason="ADR-0066: the ten full runs and the two calibrations are weekly" -->
