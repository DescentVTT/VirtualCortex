...
<!-- @assert-count target="runtime/cortex-runtime/tests/instrument.rs" symbol="_exhaustive" min="22" reason="ADR-0066, ADR-0069, ADR-0070 and ADR-0072: the ten full runs, the two calibrations, the six addressed runs, the settling, the run behind the lead-in, the composition and the ladder are weekly" -->
