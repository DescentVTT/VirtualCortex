...
The whole-domain line's job reports what each of its test binaries took, read from cargo's own result lines ([ADR-0071](adr/0071-the-exhaustive-job-times-its-own-binaries.md), F-45).
<!-- @assert-count target=".github/workflows/ci.yml" symbol="What each binary of the whole-domain tests took" min="1" reason="ADR-0071: the job reports the seconds per binary" -->
