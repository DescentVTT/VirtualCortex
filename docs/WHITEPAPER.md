...
[64..)          section directory: SectionEntry (kind, record_size, offset, length, crc64) × section_count, 64 B each
                ...
                section MODULATOR (42)   1 × 64 B                (NeuromodulatorState in the first 16 bytes, ADR-0032; written when it is not at rest)
```
...
17. Izhikevich, E. M. *Solving the distal reward problem through linkage of STDP and dopamine signaling.* Cerebral Cortex 17(10), 2007.
