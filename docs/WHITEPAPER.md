...
<!-- @assert-count target="runtime/cortex-runtime/tests/instrument.rs" symbol="_exhaustive" min="20" reason="ADR-0066, ADR-0069 and ADR-0070: the ten full runs, the two calibrations, the six addressed runs, the settling and the run behind the lead-in are weekly" -->
