...
| Arithmetic on Q16.16 state fields is saturating, or explicitly wrapping for phase counters. | `#![deny(clippy::arithmetic_side_effects)]` in the thirty-one crates that carry it ([ADR-0029](docs/adr/0029-structural-enforcement.md), three on 2026-09-10, sixteen under brief 016); review in `cortex-core` and the runtime until they migrate (brief 016, finding F-4). |
