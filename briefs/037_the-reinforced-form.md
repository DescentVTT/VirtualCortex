...
- [ ] **The three arms** — the assignment, the mirrored assignment, the shuffled reward — each 1 536 trials
...
- [ ] **The assertion.** In both rewarded arms every synapse outside the two answer pairs — the two wrong
...
- [ ] **The verdict.** The rule committed first, over the pinned tables: **H-14 is yes or no**, and
...
- [ ] **The readings, in every branch.** The selection per block and per stimulus in each arm, beside ADR-0080's
...
- [ ] **The gate.** At most one test, running no whole run: the criterion's rule at its edges over tables
  ...
  added to the gate.
- [ ] **The evidence.** A weekly dispatched on this round's branch at the scope ADR-0075 gives **this round's
...
- [ ] **The documents, in the same pull request.** Whitepaper §11.1's H-14 and its stopping rule (the step
...
- [ ] **The brief archived** as `briefs/README.md` says, every deliverable dispositioned, the frozen banner
