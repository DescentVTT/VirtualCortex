...
- [ ] **The addressing ADR (the next free number; `ls docs/adr`)** (`depends-on: ADR-0066`;
...
- [ ] **The measurement ADR (the number after it)** (`depends-on:` the addressing ADR; ADR-0066
...
- [ ] **The gate.** One test at 256 units: the addressed rewarded run's first block, 64 trials of
...
- [ ] **The documents, in the same pull request.** Whitepaper §8.8's three-factor row, §11.1's
