...
<!-- @assert-absence target="crates/cortex-reasoning" symbol="TermNode" word="true" reason="precondition: no term record exists; archive this brief when it does" -->
...
- [ ] `TermNode` (64 B, asserted, the five derives and `Default`), `Binding`, and
      ...
      to the resolvent.
- [ ] Tests: constants unify with themselves only; a variable binds and is dereferenced; the
...
- [ ] Whitepaper §5.2.30 (second record's layout and API), §6.10 step 3 (unification
